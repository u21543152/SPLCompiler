...
public class Main 
{
    ...
    public static void main(String[] args)
    {
        ...
        try 
        {
            ...
            String lexerOutputFile = "output.xml";  // This is the XML file generated by the lexer
            ...
            writeTreeToXML("syntax_tree.xml",root,innerNodes,leafNodes);
            System.out.println("syntax_tree.xml has been created!");
            //parser stage 3: make DOT file
            FileWriter writer = new FileWriter("syntax_tree.dot");
